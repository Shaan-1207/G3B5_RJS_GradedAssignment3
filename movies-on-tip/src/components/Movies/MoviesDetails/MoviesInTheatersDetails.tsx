...
import { getMoviesInTheatersById } from "../../../services/getMovies";
  ...
  useEffect(() => {
    const fetchMovie = async () => {
      try {
        ...
        const data = await getMoviesInTheatersById(id);
        setMovie(data);
        setLoading(false);
      } catch (error) {
...
export default MoviesInTheatersDetails;
